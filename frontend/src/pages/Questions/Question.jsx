    ...
    <ProtectedRoute>
      <div className="container p-4">
          ...
          <form className="flex py-4 flex-col gap-3" onSubmit={handleSubmit}>
            ...
            <textarea placeholder="Type your comment here..." className="form__input inputdata w-full h-40 whitespace-pre-wrap" onChange={(e) => setComment({...comment,comment:e.target.value})} value={comment.comment}/>
            <Button type="submit" text="Add comment" variant="gradient" extraClasses="max-sm:w-full"/>
          </form>
          <HrtLn/>
